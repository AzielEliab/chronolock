...
class Handler(BaseHTTPRequestHandler):
    server_version = "ChronoLock/0.1.0"
...
def make_server(host: str = "127.0.0.1", port: int = 8851) -> ThreadingHTTPServer:
    if host not in LOOPBACK:
        raise ValueError("ChronoLock UI binds loopback only (127.0.0.1)")
