...
<title>ChronoLock downloads</title>
<style>
...
<body>
  <h1>ChronoLock</h1>
  <p class="motto">Meaning is not only shaped by language, but by when language arrives. Advisory, not a scheduler, not targeting, not virality.</p>
  <div class="card">
    <p class="count">${n}<span> downloads of this project</span></p>
    <a class="dl" href="/download?asset=chronolock-0.1.0.tar.gz">Download chronolock-0.1.0.tar.gz — ${n} counted</a>
    ...
    <p class="iso">Isolated counter: Worker <code>chronolock-download-tracker</code>, project <code>chronolock</code>, KV <code>CHRONOLOCK_DOWNLOADS</code>. Not mixed with any other product. /v1 does not increment downloads.</p>
