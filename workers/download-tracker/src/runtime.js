...
async function advise(geo, languageHint, dialectHint) {
  ...
  payload.note = "Advisory only. Not a scheduler, not targeting, not virality. Does not change wording. Timing advice only. Objective is not influence, but legibility.";
  return payload;
}
...
function listAnchors() {
  return {
    ...
    version: VERSION,
    motto: MOTTO,
    note: "Advisory hygiene, not a scheduler, not targeting, not virality. Temporal Neutral Window 08:30–10:30 local.",
...
<title>ChronoLock — use with ChatGPT, Grok, Venice, Claude, Cursor, and other AI clients</title>
<style>
...
<body>
  ...
  <h2>ChatGPT, Grok, Venice, Claude, Cursor, Glama, Perplexity, Microsoft Copilot / Bing, Google Gemini / Vertex, Mistral, Meta AI, Apple Intelligence, Amazon Q, DuckAssist, You.com, Cohere, and other MCP/OpenAPI assistants</h2>
  ...
  <p>Paste this OpenAPI URL into GPT Actions, a custom tool, an HTTP tool, or an MCP-capable client:</p>
